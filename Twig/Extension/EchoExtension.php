...
class EchoExtension extends \Twig_Extension
{
    ...
    {
        return array(
            new \Twig_SimpleFunction('echo_twig', array($this, 'getEchoTwig')),
            new \Twig_SimpleFunction('echo_block', array($this, 'getEchoBlock')),
            new \Twig_SimpleFunction('echo_endblock', array($this, 'getEchoEndBlock')),
            new \Twig_SimpleFunction('echo_for', array($this, 'getEchoFor')),
            new \Twig_SimpleFunction('echo_endfor', array($this, 'getEchoEndFor')),
            new \Twig_SimpleFunction('echo_raw', array($this, 'getEchoRaw')),
            new \Twig_SimpleFunction('echo_endraw', array($this, 'getEchoEndRaw')),
            new \Twig_SimpleFunction('echo_spaceless', array($this, 'getEchoSpaceless')),
            new \Twig_SimpleFunction('echo_endspaceless', array($this, 'getEchoEndSpaceless')),
            new \Twig_SimpleFunction('echo_extends', array($this, 'getEchoExtends')),
            new \Twig_SimpleFunction('echo_if', array($this, 'getEchoIf')),
            new \Twig_SimpleFunction('echo_if_granted', array($this, 'getEchoIfGranted')),
            new \Twig_SimpleFunction('echo_else', array($this, 'getEchoElse')),
            new \Twig_SimpleFunction('echo_elseif', array($this, 'getEchoElseIf')),
            new \Twig_SimpleFunction('echo_endif', array($this, 'getEchoEndIf')),
            new \Twig_SimpleFunction('echo_path', array($this, 'getEchoPath')),
            new \Twig_SimpleFunction('echo_set', array($this, 'getEchoSet')),
            new \Twig_SimpleFunction('echo_trans', array($this, 'getEchoTrans')),
            new \Twig_SimpleFunction('echo_twig_assoc', array($this, 'getEchoTwigAssoc')),
            new \Twig_SimpleFunction('echo_twig_filter', array($this, 'getEchoTwigFilter')),
            new \Twig_SimpleFunction('echo_include', array($this, 'getEchoInclude')),
            new \Twig_SimpleFunction('echo_use', array($this, 'getEchoUse')),
            new \Twig_SimpleFunction('echo_print_block', array($this, 'getEchoPrintBlock')),
            new \Twig_SimpleFunction('echo_render', array($this, 'getEchoRender')),
            new \Twig_SimpleFunction('char', array($this, 'char')),
        );
    }
    ...
    {
        return array(
            new \Twig_SimpleFilter('as_php', array($this, 'asPhp')),
            new \Twig_SimpleFilter('php_name', array($this, 'phpName')),
            new \Twig_SimpleFilter('wrap', array($this, 'wrap')),
            new \Twig_SimpleFilter('convert_as_form', array($this, 'convertAsForm')),
        );
    }
